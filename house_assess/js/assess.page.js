...
AssessPage.prototype.selectPlot=function(){
    if(sessionStorage.getItem('plot_name')) $(".group-plot a input").val(sessionStorage.getItem('plot_name'));
    return this;
}
/**
 * 查看评估
...
AssessPage.prototype.ajaxRequestAssess=function(params){
    $.ajax({
        ...
        success: function (data) {
           if(data!=0){
               location.href="assess_result.html";
               sessionStorage.setItem('plot_name', "");
